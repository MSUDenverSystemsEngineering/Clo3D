...
Try {
    ...
    [string]$appVendor = 'CLO Virtual Fashion'
    [string]$appName = 'Clo3D'
    [string]$appVersion = '7.2.94'
    [string]$appArch = 'x64'
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '08/18/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        $exitCode = Execute-Process -Path "$dirFiles\CLO_Network_OnlineAuth_7_2_94_Installer_x64.exe" -Parameters "/S /USERNAME=msudenver /D=$envProgramFiles\CLO3D\" -WindowStyle "Hidden" -PassThru
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        $exitCode = Execute-Process -Path "$envProgramFiles\CLO3D\Uninstall.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
        If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/QygBl+2Amv95
# 3wOF2oEI5ptNRFu/2SYqDTtz7nQBTKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAzv9G4Cz6gcQbQ
# 3JX1mEeuMFkNwda3totQL6VP5ZIRnTANBgkqhkiG9w0BAQEFAASCAYBGsHqui7k7
# sF/aqCZlkKZSRhxG0YqXpPmr4Huas7cZqveQloet/+s2QEPVq71bPp6Sqk+WKcMW
# T+s/yc5+tJJqqf/inYfW7gDDGMZplhmfA8c+1wgdCrk69MLvP/e6mrfTs3uztjk2
# Mm2FWpzRyWsaG2IVR0OlzW9NvNwsxCA9uGVhR9Tk+xSeok7DpULwCNyvGLkNVp3R
# v6C7IRzcsfWcrErgRtPU4nohvgG3PDH/SRuijSuY2hWgoZtH6sXvV/8jyGonqPkk
# zjsQuQUoUT//Dr5bUN5xGR43pwfF0ejz/L8013emHGpbEnoqQHK1uhxsUQuaqCwX
# InpmpfpGAKfgyLqpgaBt4s9tXwt7a697Qtby0411OBIj0SSdmWxpMmhehc7aVWXd
# yA8/Dij2SZmRx/QqvBCjJbnpodWgwRtcYL7TW94SSRWClI1kf5GHXwAOLcpzTECg
# 8SU+ovgkrUTcsjWqb9jUblDA6vaXCJewnJ+UmGFwEpH+oxgHPYnrx/KhggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwODE4MjMx
# NjA3WjA/BgkqhkiG9w0BCQQxMgQwgcAglh9OKD8Vn9RUzUiEkwkRhFFFk+aNkq7f
# 8NAQ9eMNd0hVmEyvJfT1jxHpui2kMA0GCSqGSIb3DQEBAQUABIICACO9dorqGeYV
# dPREnWTzfd2R/Z7JC9uygUrZWK5qki/mzODCKlSKJpcmFgjf5DRXpnu2JZZi1W6h
# hkim/x4G9JtpAA/zTfJpC94bqNvXiSV8AaEhvwlyxWUdNQetP1cffwNZRYLjSVrh
# Af+rMA3nKx1nN4gWoMQPxFKb+lwe1BsP3whKd3WlaN1Y6I0Iq1B6Rj5eqaYYUs2x
# roj9rV0kQH0J4RrFXINQzt3aQ/Y9Lqcx341V6aHt0vzS1NUGUiU0alTtazdm9vJB
# l+Lyeje7ET5bLJvrXsOCE2xPmay8RIp+tEJ/qX6aYjnQtZS2n09YRPH3h4s584GS
# FfobXt6gNXRsDBvFOZVywhEj4EnEUJkEiG1aqvyov4plD9dM13P0ypPxNFl/TGnj
# DOjmykxIUH2na7cKWL3wWNax0eV7v5P2bvwb4CL3P1KMuNWVvfd1qIvaZMG6JfDE
# H+aPGrto4nVX04K5/huJjswc55lZk+smUFvIGt1sQZXdQLLr3MiYzWAlEfqu32KE
# sUHkTpo1OZf/IAaFGraceNSBFUsmeUH61ZUk6XcyWBLt4Sa5Pl5RgnuqWAipGSP/
# 1k0lNh2P7vLAUBCGTazTm/91gJ8ILwAY3jiHoFvzATbzr8fVWTq3HUUjqS5JgCum
# f/2LZtmhUhbxOQksZuztg9SJ67Ttw8sd
